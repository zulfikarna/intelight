...
-- Command     : write_vhdl -force -mode funcsim -rename_top memory_bram_interface_0_0 -prefix
--               memory_bram_interface_0_0_ testbench_bram_interface_0_0_sim_netlist.vhdl
...
entity memory_bram_interface_0_0_reg_2bit is
  port (
...
end memory_bram_interface_0_0_reg_2bit;

architecture STRUCTURE of memory_bram_interface_0_0_reg_2bit is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0_reg_2bit_0 is
  port (
  ...
  attribute ORIG_REF_NAME of memory_bram_interface_0_0_reg_2bit_0 : entity is "reg_2bit";
end memory_bram_interface_0_0_reg_2bit_0;

architecture STRUCTURE of memory_bram_interface_0_0_reg_2bit_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0_reg_32bit is
  port (
...
end memory_bram_interface_0_0_reg_32bit;

architecture STRUCTURE of memory_bram_interface_0_0_reg_32bit is
begin
\out0_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0_reg_32bit_1 is
  port (
    Q : out STD_LOGIC_VECTOR ( 29 downto 0 );
    rst : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of memory_bram_interface_0_0_reg_32bit_1 : entity is "reg_32bit";
end memory_bram_interface_0_0_reg_32bit_1;

architecture STRUCTURE of memory_bram_interface_0_0_reg_32bit_1 is
begin
\out0_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0_reg_32bit_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of memory_bram_interface_0_0_reg_32bit_2 : entity is "reg_32bit";
end memory_bram_interface_0_0_reg_32bit_2;

architecture STRUCTURE of memory_bram_interface_0_0_reg_32bit_2 is
begin
\out0_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0_reg2_2bit is
  port (
    en1 : out STD_LOGIC_VECTOR ( 0 to 0 );
    en2 : out STD_LOGIC_VECTOR ( 0 to 0 );
    en0 : out STD_LOGIC_VECTOR ( 0 to 0 );
...
end memory_bram_interface_0_0_reg2_2bit;

architecture STRUCTURE of memory_bram_interface_0_0_reg2_2bit is
  signal reg0_n_0 : STD_LOGIC;
  signal reg0_n_1 : STD_LOGIC;
begin
reg0: entity work.memory_bram_interface_0_0_reg_2bit
     port map (
      Q(1) => reg0_n_0,
      Q(0) => reg0_n_1,
...
reg1: entity work.memory_bram_interface_0_0_reg_2bit_0
     port map (
      D(1) => reg0_n_0,
      D(0) => reg0_n_1,
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0_reg3_32bit is
  port (
    wr_addr : out STD_LOGIC_VECTOR ( 29 downto 0 );
    rst : in STD_LOGIC;
    next_state : in STD_LOGIC_VECTOR ( 29 downto 0 );
...
end memory_bram_interface_0_0_reg3_32bit;

architecture STRUCTURE of memory_bram_interface_0_0_reg3_32bit is
  signal reg0_n_0 : STD_LOGIC;
  signal reg0_n_1 : STD_LOGIC;
...
begin
reg0: entity work.memory_bram_interface_0_0_reg_32bit
     port map (
      Q(29) => reg0_n_0,
      Q(28) => reg0_n_1,
      Q(27) => reg0_n_2,
...
reg1: entity work.memory_bram_interface_0_0_reg_32bit_1
     port map (
      D(29) => reg0_n_0,
      D(28) => reg0_n_1,
      D(27) => reg0_n_2,
...
reg2: entity work.memory_bram_interface_0_0_reg_32bit_2
     port map (
      D(29) => reg1_n_0,
      D(28) => reg1_n_1,
      D(27) => reg1_n_2,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0_bram_interface is
  port (
    en1 : out STD_LOGIC_VECTOR ( 0 to 0 );
    en2 : out STD_LOGIC_VECTOR ( 0 to 0 );
    wr_addr : out STD_LOGIC_VECTOR ( 29 downto 0 );
...
end memory_bram_interface_0_0_bram_interface;

architecture STRUCTURE of memory_bram_interface_0_0_bram_interface is
begin
reg0: entity work.memory_bram_interface_0_0_reg3_32bit
     port map (
      clk => clk,
      next_state(29 downto 0) => next_state(29 downto 0),
      rst => rst,
...
reg1: entity work.memory_bram_interface_0_0_reg2_2bit
     port map (
      act(1 downto 0) => act(1 downto 0),
      clk => clk,
      en0(0) => en0(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity memory_bram_interface_0_0 is
  port (
    clk : in STD_LOGIC;
    rst : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of memory_bram_interface_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of memory_bram_interface_0_0 : entity is "testbench_bram_interface_0_0,bram_interface,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of memory_bram_interface_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of memory_bram_interface_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of memory_bram_interface_0_0 : entity is "bram_interface,Vivado 2021.1";
end memory_bram_interface_0_0;

architecture STRUCTURE of memory_bram_interface_0_0 is
...
inst: entity work.memory_bram_interface_0_0_bram_interface
     port map (
      act(1 downto 0) => act(1 downto 0),
      clk => clk,
      en0(0) => \^en0\(3),
