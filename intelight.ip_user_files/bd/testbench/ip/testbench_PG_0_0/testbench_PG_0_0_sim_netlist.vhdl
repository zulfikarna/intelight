...
-- Date        : Wed Mar 23 18:04:27 2022
-- Host        : DESKTOP-LNFBGQQ running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/intelight/intelight/intelight.gen/sources_1/bd/testbench/ip/testbench_PG_0_0/testbench_PG_0_0_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity testbench_PG_0_0_max2to1_32bit is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity testbench_PG_0_0_max4to1_32bit is
  port (
...
begin
max0: entity work.testbench_PG_0_0_max2to1_32bit
     port map (
      CO(0) => max0_n_0,
      DI(3) => max2_n_13,
      DI(2) => max2_n_14,
...
entity testbench_PG_0_0 is
  ...
  attribute IP_DEFINITION_SOURCE of testbench_PG_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of testbench_PG_0_0 : entity is "PG,Vivado 2021.1";
end testbench_PG_0_0;

architecture STRUCTURE of testbench_PG_0_0 is
