...
--               d:/intelight/intelight_backup3/intelight.gen/sources_1/bd/testbench/ip/testbench_RD_0_0/testbench_RD_0_0_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity testbench_RD_0_0_mux4to1_32bit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of testbench_RD_0_0_mux4to1_32bit : entity is "mux4to1_32bit";
end testbench_RD_0_0_mux4to1_32bit;

architecture STRUCTURE of testbench_RD_0_0_mux4to1_32bit is
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity testbench_RD_0_0_reg_3bit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of testbench_RD_0_0_reg_3bit : entity is "reg_3bit";
end testbench_RD_0_0_reg_3bit;

architecture STRUCTURE of testbench_RD_0_0_reg_3bit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity testbench_RD_0_0_reg_3bit_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of testbench_RD_0_0_reg_3bit_0 : entity is "reg_3bit";
end testbench_RD_0_0_reg_3bit_0;

architecture STRUCTURE of testbench_RD_0_0_reg_3bit_0 is
...
reg0: entity work.testbench_RD_0_0_reg_3bit
     port map (
      clk => clk,
      rst => rst,
...
reg1: entity work.testbench_RD_0_0_reg_3bit_0
     port map (
      clk => clk,
      rst => rst,
      state(11 downto 0) => state(11 downto 0),
...
reg4: entity work.testbench_RD_0_0_reg_2bit
     port map (
      D(1) => reg3_n_0,
      D(0) => w_sel(0),
...
rd0: entity work.testbench_RD_0_0_mux4to1_32bit
     port map (
      D(31 downto 0) => w_reward(31 downto 0),
      Q(1 downto 0) => \^q\(1 downto 0),
