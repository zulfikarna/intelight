...
#
# Generated by export_simulation on Sat Mar 05 17:32:28 +0700 2022
#
################################################################################
...
'-reset_run' switch to the './AGENT.sh' script.
...
./AGENT.sh -noclean_files

For more information on the script, please type './AGENT.sh -help'.
