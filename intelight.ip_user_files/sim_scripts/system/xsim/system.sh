...
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -protoinst "protoinst_files/bram.protoinst" -protoinst "protoinst_files/action_ram.protoinst" -log simulate.log
}
