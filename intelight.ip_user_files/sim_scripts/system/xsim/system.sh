...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -protoinst "protoinst_files/AGENT.protoinst" -protoinst "protoinst_files/BRAM_QA.protoinst" -protoinst "protoinst_files/bram.protoinst" -protoinst "protoinst_files/action_ram.protoinst" -log simulate.log
}
