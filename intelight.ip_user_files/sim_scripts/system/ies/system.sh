...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../intelight.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../intelight.gen/sources_1/bd/system/ipshared/f42d/hdl" \
       +incdir+"../../../../intelight.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../intelight.gen/sources_1/bd/system/ipshared/f42d/hdl" \
