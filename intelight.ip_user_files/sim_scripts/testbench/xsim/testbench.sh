...
simulate()
{
  xsim testbench -key {Behavioral:sim_1:Functional:testbench} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -protoinst "protoinst_files/testbench.protoinst" -log simulate.log
}
