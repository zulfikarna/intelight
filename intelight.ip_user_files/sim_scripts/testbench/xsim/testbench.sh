...
simulate()
{
  xsim testbench -key {Behavioral:sim_1:Functional:testbench} -tclbatch cmd.tcl -protoinst "protoinst_files/testbench.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
