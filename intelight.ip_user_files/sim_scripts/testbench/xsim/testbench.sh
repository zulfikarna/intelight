...
# Set xvlog options
xvlog_opts="--incr --relax -L axi_vip_v1_1_10 -L processing_system7_vip_v1_0_12 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xlconstant_v1_1_7 -L blk_mem_gen_v8_4_4 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot testbench xil_defaultlib.testbench xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim testbench -key {Behavioral:sim_1:Functional:testbench} -tclbatch cmd.tcl -protoinst "protoinst_files/testbench.protoinst" -protoinst "protoinst_files/memory.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb testbench.wdb xsim.dir)
