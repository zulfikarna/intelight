...
module SD(
    ...
    multiply        mult0   (.in0(debit_r0),           .c(delta_t),           .out0(delta_panjang_r0));
    ...
    multiply        mult1   (.in0(debit_r1),           .c(delta_t),           .out0(delta_panjang_r1));
    ...
    multiply        mult2   (.in0(debit_r2),           .c(delta_t),           .out0(delta_panjang_r2));
    ...
    multiply        mult3   (.in0(debit_r3),           .c(delta_t),           .out0(delta_panjang_r3));
    ...
    assign level_r3 =   (panjang_r3 < batas_0)                              ? 8'd0:
                        ...
                        ((panjang_r3 >= batas_1)&&(panjang_r3 < batas_2))   ? 8'd2:
                                                                              8'd3;
    assign state    = (level_r0)||(level_r1<<2)||(level_r2<<4)||(level_r3<<8);
