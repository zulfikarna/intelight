...
HD_PWD='D:/intelight/intelight/intelight.runs/system_RD_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_RD_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_RD_0_1.tcl
