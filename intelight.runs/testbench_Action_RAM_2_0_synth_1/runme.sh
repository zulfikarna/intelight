...
HD_PWD='D:/intelight/intelight/intelight.runs/testbench_Action_RAM_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_Action_RAM_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_Action_RAM_2_0.tcl
