...
HD_PWD='D:/intelight/intelight_backup3/intelight.runs/testbench_RD_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_RD_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_RD_0_0.tcl
