...
HD_PWD='D:/intelight/intelight_backup2/intelight.runs/system_bram_output_interface_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bram_output_interface_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bram_output_interface_0_2.tcl
