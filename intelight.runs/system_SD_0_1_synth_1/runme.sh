...
HD_PWD='D:/intelight/intelight/intelight.runs/system_SD_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_SD_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_SD_0_1.tcl
