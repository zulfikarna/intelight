...
HD_PWD='D:/intelight/intelight/intelight.runs/testbench_bram_output_interface_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_bram_output_interface_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_bram_output_interface_0_0.tcl
