...
HD_PWD='D:/intelight/intelight_backup3/intelight.runs/system_EG_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_EG_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_EG_0_0.tcl
