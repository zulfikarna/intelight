...
HD_PWD='D:/Dismas/ITB/SemesterVIII/TA2/intelight/intelight.runs/system_reg_32bit_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_reg_32bit_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_reg_32bit_0_1.tcl
