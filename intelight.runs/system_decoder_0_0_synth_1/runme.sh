...
HD_PWD='D:/Dismas/ITB/SemesterVIII/TA2/intelight/intelight.runs/system_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_decoder_0_0.tcl
