...
HD_PWD='D:/intelight/intelight_backup3/intelight.runs/system_intelight_mem_v2_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_intelight_mem_v2_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_intelight_mem_v2_0_1.tcl
