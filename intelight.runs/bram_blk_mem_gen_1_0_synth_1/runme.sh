...
HD_PWD='D:/Dismas/ITB/SemesterVIII/TA2/intelight/intelight.runs/bram_blk_mem_gen_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_blk_mem_gen_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_blk_mem_gen_1_0.tcl
