...
HD_PWD='D:/intelight/intelight_backup2/intelight.runs/system_PL_RAM_1_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_PL_RAM_1_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_PL_RAM_1_3.tcl
