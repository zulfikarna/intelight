...
HD_PWD='D:/Dismas/ITB/SemesterVIII/TA2/intelight/intelight.runs/system_Action_RAM_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Action_RAM_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Action_RAM_1_0.tcl
