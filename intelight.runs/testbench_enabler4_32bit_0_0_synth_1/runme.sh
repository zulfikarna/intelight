...
HD_PWD='D:/intelight/intelight/intelight.runs/testbench_enabler4_32bit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_enabler4_32bit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_enabler4_32bit_0_0.tcl
