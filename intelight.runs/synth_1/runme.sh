...
HD_PWD='D:/intelight/intelight/intelight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testbench_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testbench_wrapper.tcl
