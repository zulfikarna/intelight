...
# ssh.connect(hostname='192.168.2.99', username='xilinx', password='xilinx', port=9090)

# import urllib 
# from smb.SMBHandler import SMBHandler 
# opener = urllib.request.build_opener(SMBHandler)
# state_adapt = opener.open('smb://pynq/xilinx/jupyter_notebooks/intelight/state_adapt.csv')
# action_adapt = opener.open('smb://pynq/xilinx/jupyter_notebooks/intelight/action_adapt.csv')
...
def repeat():
    ...
    # dir_path = "smb:\\pynq\\xilinx\\jupyter_notebooks\\intelight"   #ganti2 sesuai directorynya
    ...
    with open(filename_send, 'w', encoding='UTF8',newline='') as f:        #state_to_PYNQ
    ...
    file_recv.close()
    with open(filename_recv, 'r') as file:                                #action_from_PYNQ
