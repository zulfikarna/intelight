...
ssh.connect(hostname='172.20.10.4',username='xilinx',password='xilinx',port=9090)
sftp_client=ssh.open_sftp
sftp_client.chdir("/pynq/xilinx/jupyter_notebooks/intelight")
...
def repeat():
    ...
    # dir_path = 'smb://pynq/xilinx/jupyter_notebooks/intelight'
    # file_name_state = "state_for_PYNQ.csv"
    # file_name_action = "action_from_PYNQ.csv"

    # completeName_state = '/notebooks/intelight/state_for_PYNQ.csv @ 172.20.10.4'
    # completeName_action = '/notebooks/intelight/action_from_PYNQ.csv @ 172.20.10.4'
    # completeName_state = os.path.join(dir_path, file_name_state)
    # completeName_action = os.path.join(dir_path, file_name_action)
    completeName_state = opener.open('smb://pynq/xilinx/jupyter_notebooks/intelight/state_for_PYNQ.csv')
    completeName_action = opener.open('smb://pynq/xilinx/jupyter_notebooks/intelight/action_from_PYNQ.csv')
