...
################################################################
# This is a generated script based on design: BRAM_QA
#
...
# source BRAM_QA_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# QA, decoder, reg_2bit, reg_32bit
...
proc create_root_design { parentCell } {
  ...
  set next_action [ create_bd_port -dir I -from 1 -to 0 next_action ]
  ...
  set reward [ create_bd_port -dir I -from 31 -to 0 reward ]
  ...
  connect_bd_net -net QA_0_curr_qA0 [get_bd_ports curr_qA0] [get_bd_pins QA_0/curr_qA0]
  connect_bd_net -net QA_0_curr_qA1 [get_bd_ports curr_qA1] [get_bd_pins QA_0/curr_qA1]
  connect_bd_net -net QA_0_curr_qA2 [get_bd_ports curr_qA2] [get_bd_pins QA_0/curr_qA2]
  connect_bd_net -net QA_0_curr_qA3 [get_bd_ports curr_qA3] [get_bd_pins QA_0/curr_qA3]
  connect_bd_net -net QA_0_new_qA [get_bd_ports new_qA] [get_bd_pins Action_RAM/q_new] [get_bd_pins QA_0/new_qA]
  connect_bd_net -net alpha_0_1 [get_bd_ports alpha] [get_bd_pins QA_0/alpha]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins Action_RAM/clk_bram] [get_bd_pins QA_0/clk]
  connect_bd_net -net gamma_0_1 [get_bd_ports gamma] [get_bd_pins QA_0/gamma]
  connect_bd_net -net next_action_0_1 [get_bd_ports next_action] [get_bd_pins Action_RAM/next_action]
  connect_bd_net -net next_state_1 [get_bd_ports next_state] [get_bd_pins Action_RAM/next_state]
  connect_bd_net -net reward_0_1 [get_bd_ports reward] [get_bd_pins QA_0/reward]
  connect_bd_net -net rsta_0_1 [get_bd_ports rst] [get_bd_pins Action_RAM/rst_bram] [get_bd_pins QA_0/rst]
