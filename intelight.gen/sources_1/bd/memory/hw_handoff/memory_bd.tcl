...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net bram_interface_0_en0 [get_bd_ports en0] [get_bd_pins RAM_Block/wea_0] [get_bd_pins bram_interface_0/en0]
  connect_bd_net -net bram_interface_0_en1 [get_bd_ports en1] [get_bd_pins RAM_Block/wea_1] [get_bd_pins bram_interface_0/en1]
  connect_bd_net -net bram_interface_0_en2 [get_bd_ports en2] [get_bd_pins RAM_Block/wea_2] [get_bd_pins bram_interface_0/en2]
  connect_bd_net -net bram_interface_0_en3 [get_bd_ports en3] [get_bd_pins RAM_Block/wea_3] [get_bd_pins bram_interface_0/en3]
