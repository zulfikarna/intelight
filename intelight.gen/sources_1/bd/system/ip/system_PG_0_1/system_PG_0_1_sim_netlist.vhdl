...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_PG_0_1_max2to1_32bit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_PG_0_1_max2to1_32bit : entity is "max2to1_32bit";
end system_PG_0_1_max2to1_32bit;

architecture STRUCTURE of system_PG_0_1_max2to1_32bit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_PG_0_1_max2to1_32bit_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_PG_0_1_max2to1_32bit_0 : entity is "max2to1_32bit";
end system_PG_0_1_max2to1_32bit_0;

architecture STRUCTURE of system_PG_0_1_max2to1_32bit_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_PG_0_1_max2to1_32bit_1 is
  port (
    \qA1[30]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_PG_0_1_max2to1_32bit_1 : entity is "max2to1_32bit";
end system_PG_0_1_max2to1_32bit_1;

architecture STRUCTURE of system_PG_0_1_max2to1_32bit_1 is
  signal \out01_carry__0_n_0\ : STD_LOGIC;
  signal \out01_carry__0_n_1\ : STD_LOGIC;
  signal \out01_carry__0_n_2\ : STD_LOGIC;
  signal \out01_carry__0_n_3\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_PG_0_1_reg_2bit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_PG_0_1_reg_2bit : entity is "reg_2bit";
end system_PG_0_1_reg_2bit;

architecture STRUCTURE of system_PG_0_1_reg_2bit is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_PG_0_1_max4to1_32bit is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_PG_0_1_max4to1_32bit : entity is "max4to1_32bit";
end system_PG_0_1_max4to1_32bit;

architecture STRUCTURE of system_PG_0_1_max4to1_32bit is
...
begin
max0: entity work.system_PG_0_1_max2to1_32bit
     port map (
      CO(0) => max0_n_0,
      DI(3) => max2_n_13,
      DI(2) => max2_n_14,
...
max1: entity work.system_PG_0_1_max2to1_32bit_0
     port map (
      CO(0) => max0_n_0,
      DI(3) => max2_n_5,
      DI(2) => max2_n_6,
...
max2: entity work.system_PG_0_1_max2to1_32bit_1
     port map (
      DI(3) => max1_n_31,
      DI(2) => max0_n_58,
      DI(1) => max0_n_59,
...
greed_action: entity work.system_PG_0_1_max4to1_32bit
     port map (
...
reg0: entity work.system_PG_0_1_reg_2bit
     port map (
      CO(0) => w_act_greed1,
      act_greed(1 downto 0) => \^act_greed\(1 downto 0),
      clk => clk,
