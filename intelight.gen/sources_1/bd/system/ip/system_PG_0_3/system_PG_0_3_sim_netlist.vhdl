...
--               system_PG_0_3_ system_PG_0_1_sim_netlist.vhdl
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_PG_0_3_max2to1_32bit_0 is
  port (
  ...
  attribute ORIG_REF_NAME of system_PG_0_3_max2to1_32bit_0 : entity is "max2to1_32bit";
end system_PG_0_3_max2to1_32bit_0;

architecture STRUCTURE of system_PG_0_3_max2to1_32bit_0 is
...
max1: entity work.system_PG_0_3_max2to1_32bit_0
     port map (
      CO(0) => max0_n_0,
      DI(3) => max2_n_1,
      DI(2) => max2_n_2,
...
max2: entity work.system_PG_0_3_max2to1_32bit_1
     port map (
      DI(3) => max1_n_80,
      DI(2) => max0_n_14,
      DI(1) => max0_n_15,
...
entity system_PG_0_3 is
  ...
  attribute CHECK_LICENSE_TYPE of system_PG_0_3 : entity is "system_PG_0_1,PG,{}";
