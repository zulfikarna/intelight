...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra_0 [ create_bd_port -dir I -from 31 -to 0 addra_0 ]
  set addrb_0 [ create_bd_port -dir I -from 31 -to 0 addrb_0 ]
  ...
  connect_bd_net -net clka_0_1 [get_bd_ports clka_0] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net dina_0_1 [get_bd_ports dina_0] [get_bd_pins blk_mem_gen_0/dina]
  connect_bd_net -net rsta_0_1 [get_bd_ports rsta_0] [get_bd_pins blk_mem_gen_0/rsta] [get_bd_pins blk_mem_gen_0/rstb]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins blk_mem_gen_0/web] [get_bd_pins xlconstant_2/dout]
