...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_enabler_2bit is
  ...
  attribute XILINX_LEGACY_PRIM of \out0_reg_reg[0]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \out0_reg_reg[1]\ : label is "LD";
begin
\out0_reg_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\out0_reg_reg[1]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\out0_reg_reg[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AA00AACF"
    )
        port map (
...
\out0_reg_reg[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"888B"
    )
        port map (
