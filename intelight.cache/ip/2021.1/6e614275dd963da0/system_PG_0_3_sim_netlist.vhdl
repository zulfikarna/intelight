...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_enabler_2bit is
  port (
    ...
    en : in STD_LOGIC;
    finish : in STD_LOGIC;
    act_0_sp_1 : in STD_LOGIC;
    act_sim : in STD_LOGIC_VECTOR ( 1 downto 0 );
    act_1_sp_1 : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_enabler_2bit is
  signal act_0_sn_1 : STD_LOGIC;
  signal act_1_sn_1 : STD_LOGIC;
begin
  act_0_sn_1 <= act_0_sp_1;
  act_1_sn_1 <= act_1_sp_1;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_2bit is
  port (
    ...
    CO : in STD_LOGIC_VECTOR ( 0 to 0 );
    \out0_reg[1]_1\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    sel : in STD_LOGIC;
    act_random : in STD_LOGIC_VECTOR ( 1 downto 0 );
    rst : in STD_LOGIC;
    \out0_reg[0]_1\ : in STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC
  );
...
en0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_enabler_2bit
     port map (
      ...
      act_0_sp_1 => reg0_n_1,
      act_1_sp_1 => reg0_n_0,
      act_sim(1 downto 0) => act_sim(1 downto 0),
      en => en,
      finish => finish
    );
...
reg0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_2bit
     port map (
      ...
      clk => clk,
      \out0_reg[0]_0\ => reg0_n_1,
      \out0_reg[0]_1\(0) => act_greed3,
      \out0_reg[1]_0\ => reg0_n_0,
      \out0_reg[1]_1\(0) => act_greed1,
      rst => rst,
      sel => sel
    );
end STRUCTURE;
