...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_32bit is
  ...
  signal state_temp1 : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \state[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[1]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state[2]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[3]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \state[4]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[5]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \state[6]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \state[7]_INST_0\ : label is "soft_lutpair7";
begin
...
\state[4]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\state[5]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\state[6]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\state[7]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
