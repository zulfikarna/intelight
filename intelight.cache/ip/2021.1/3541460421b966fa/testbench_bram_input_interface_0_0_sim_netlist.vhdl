...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ testbench_bram_input_interface_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_reg_2bit_2 is
  ...
  attribute SOFT_HLUTNM of en1_rd_INST_0 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of en1_wr_INST_0 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of en2_rd_INST_0 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of en3_wr_INST_0 : label is "soft_lutpair3";
begin
en0_rd_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
en0_wr_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
en1_rd_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
en1_wr_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
en2_rd_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
en2_wr_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
en3_rd_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
en3_wr_INST_0: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "testbench_bram_input_interface_0_0,bram_input_interface,{}";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^en1_wr\ : STD_LOGIC;
  signal \^en2_wr\ : STD_LOGIC;
