...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst, start, read_sig, max_step, max_episode, 
  ...
  finish)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,start,read_sig,max_step[15:0],max_episode[15:0],seed[15:0],goal_sig,sel_act,act_random[1:0],BRAM_rd,BRAM_wr,PG,QA,SD,RD,wire_sc[15:0],wire_ec[15:0],wire_cs[3:0],wire_as[15:0],finish" */;
  input clk;
  input rst;
  input start;
  input read_sig;
