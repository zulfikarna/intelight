...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_ns[1]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of RD_INST_0 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \wire_cs[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \wire_cs[1]_INST_0\ : label is "soft_lutpair5";
...
\FSM_sequential_ns[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"1F"
    )
        port map (
