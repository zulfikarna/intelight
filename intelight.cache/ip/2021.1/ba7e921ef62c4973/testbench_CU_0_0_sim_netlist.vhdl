...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU is
  port (
    ...
    start : in STD_LOGIC;
    read_sig_arduino : in STD_LOGIC;
    sel_state_sim : in STD_LOGIC;
    read_sig_python : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_ns[11]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FSM_onehot_ns[12]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \FSM_onehot_ns[1]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \FSM_onehot_ns[5]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FSM_onehot_ns[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of PG_INST_0_i_1 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \epsilon_reg[15]_i_1\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of read_sig_INST_0 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \wire_cs[0]_INST_0_i_1\ : label is "soft_lutpair4";
begin
  Q(0) <= \^q\(0);
...
\FSM_onehot_ns[12]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80888000"
    )
        port map (
...
read_sig_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU
     port map (
      ...
      read_sig => read_sig,
      read_sig_arduino => read_sig_arduino,
      read_sig_python => read_sig_python,
      rst => rst,
      seed(15 downto 0) => seed(15 downto 0),
      sel_act => sel_act,
      sel_state_sim => sel_state_sim,
      start => start,
      wire_as(15 downto 0) => wire_as(15 downto 0),
